    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/products/**").hasRole("product_read")
                        .requestMatchers(HttpMethod.POST, "/api/products/**").hasRole("product_write")
                        .requestMatchers(HttpMethod.PUT, "/api/products/**").hasRole("product_write")
                        .requestMatchers(HttpMethod.DELETE, "/api/products/**").hasRole("product_write")
